/* --- Generated the 1/12/2025 at 12:53 --- */
...
void Scheduler__select_largest_period_step(Scheduler__select_acc acc[3],
...
void Scheduler__select_tasks_step(Scheduler_data__task_status ts[5],
  ...
  Scheduler__select_acc v[3];
  Scheduler__select_acc tmp[3];
  {
    int _6;
...
void Scheduler__rate_monotonic_mc_step(Scheduler_data__task_status ts[5],
...
void Scheduler__extract_aux_step(Scheduler_data__task_status s, int tid,
                                 int acc[3], Scheduler__extract_aux_out* _out) {
...
void Scheduler__extract_proc_step(Scheduler_data__task_status ts[5],
...
void Scheduler__scheduler_reset(Scheduler__scheduler_mem* self) {
  ...
  };
  {
    ...
    for (_20 = 0; _20 < 5; ++_20) {
      ...
      self->ss.tasks[_20].current_proc = 3;
...
void Scheduler__scheduler_step(int task_end[5],
  ...
  int new_date;
  Scheduler_data__task_status tmp1[5];
  Scheduler_data__task_status tmp2[5];
  Scheduler_data__task_status tmp3[5];
  Scheduler_data__task_status tmp4[5];
  {
    int i_4;
    for (i_4 = 0; i_4 < Scheduler_data__ntasks; ++i_4) {
